    ...
    <div className="mt-8 grid grid-cols-3 gap-2">
      {providers.map((p) => (
        <button
          ...
          className="border border-foreground bg-input-background py-3 px-3 flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] hover:border-primary hover:text-primary transition-colors duration-100 cursor-pointer"
          type="button"
        >
          {p.svg}
