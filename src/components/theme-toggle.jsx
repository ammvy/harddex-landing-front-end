...
export default function ThemeToggle() {
  ...
  return <button onClick={toggleTheme} aria-label="Alternar tema" className="w-9 h-9 border border-foreground flex items-center justify-center hover:text-primary hover:border-primary transition-colors duration-100 cursor-pointer">
