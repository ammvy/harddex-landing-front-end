...
export const ProCat = ({
  className
    ...
    <path d="M 50 132 L 80 152 L 110 132 L 116 196 L 44 196 Z" fill={DETAIL} />
    <path d="M 60 132 L 80 146 L 100 132" stroke={BODY} strokeWidth="1.6" fill="none" />
