...
export const MobileCat = ({
  className
    ...
    <path d="M 46 36 Q 80 -2 122 30" stroke={DETAIL} strokeWidth="3.4" fill="none" />
    ...
    <g transform="translate(80 168)">
      ...
      <path d="M 18 -8 Q 30 -6 30 4 Q 30 14 18 12" stroke={DETAIL} strokeWidth="2.4" fill="none" />
      <rect x="-14" y="-18" width="28" height="4" fill={BODY} />
      <path d="M -6 -22 Q -6 -28 -2 -28" stroke={ACCENT} strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <path d="M 2 -22 Q 2 -28 6 -28" stroke={ACCENT} strokeWidth="1.6" fill="none" strokeLinecap="round" />
    </g>
  </CatHeadBase>;
export const MobileMiniCat = ({
  className
} = {}) => <MiniCatBase className={className}>
    <path d="M 28 26 Q 50 -4 76 22" stroke={DETAIL} strokeWidth="2.2" fill="none" />
