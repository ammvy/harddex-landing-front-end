...
export function MiniCatBase({
  ...
  return <svg viewBox="0 0 100 100" className={cn("w-full h-full", className)} {...props}>
      ...
      <path d="M 18 46 Q 18 32 32 32 L 68 32 Q 82 32 82 46 L 82 76 Q 82 92 50 92 Q 18 92 18 76 Z" fill={BODY} />
      ...
      <path d="M 50 74 Q 50 78 47 78 M 50 74 Q 50 78 53 78" stroke={DETAIL} strokeWidth="0.9" fill="none" strokeLinecap="round" />
      {children}
    </svg>;
}