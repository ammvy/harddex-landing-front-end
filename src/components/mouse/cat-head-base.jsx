...
export function CatHeadBase({
  ...
  return <svg viewBox="0 0 160 200" className={cn("w-full h-auto max-w-[280px]", className)} {...props}>
      ...
      <path d="M 30 60 Q 30 44 50 44 L 110 44 Q 130 44 130 60 L 130 110 Q 130 130 80 130 Q 30 130 30 110 Z" fill={BODY} />
      ...
      <path d="M 80 102 Q 80 108 76 108 M 80 102 Q 80 108 84 108" stroke={DETAIL} strokeWidth="1.4" fill="none" strokeLinecap="round" />
      {children}
    </svg>;
}