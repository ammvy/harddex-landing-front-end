...
export function CatHead() {
  ...
  return <g>
      ...
      <path d="M 22 28 Q 22 18 32 18 L 68 18 Q 78 18 78 28 L 78 52 Q 78 64 50 64 Q 22 64 22 52 Z" fill={body} />
      <circle cx="38" cy="44" r="3" fill={eye} />
      <circle cx="62" cy="44" r="3" fill={eye} />
      <path d="M 48 52 L 52 52 L 50 55 Z" fill={accent} />
      <path d="M 50 55 Q 50 58 47 58 M 50 55 Q 50 58 53 58" stroke={detail} strokeWidth="0.9" fill="none" strokeLinecap="round" />
    </g>;
}