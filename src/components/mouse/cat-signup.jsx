...
export default function CatSignup({
  ...
  return <motion.svg viewBox="0 0 120 150" className="w-full h-auto max-w-[320px]" animate={{
    y: [0, -4, 0]
  }} transition={{
    duration: 3.4,
    repeat: Infinity,
    ease: "easeInOut"
      ...
      <motion.path d="M 92 110 Q 110 100 112 78 Q 113 64 104 60" stroke="var(--mouse-body)" strokeWidth="3.5" fill="none" strokeLinecap="round" animate={{
      d: ["M 92 110 Q 110 100 112 78 Q 113 64 104 60", "M 92 110 Q 114 96 110 74 Q 108 60 100 58", "M 92 110 Q 110 100 112 78 Q 113 64 104 60"]
    }} transition={{
      duration: 2.8,
      repeat: Infinity,
      ease: "easeInOut"
      ...
      <path d="M 32 38 Q 32 28 42 28 L 78 28 Q 88 28 88 38 L 88 62 Q 88 74 60 74 Q 32 74 32 62 Z" fill="var(--mouse-body)" />
      ...
      <path d="M 60 65 Q 56 70 55 67 M 60 65 Q 64 70 65 67 M 56 68 Q 60 72 64 68" stroke="var(--mouse-detail)" strokeWidth="1" fill="none" strokeLinecap="round" strokeLinejoin="round" />

      <path d="M 40 74 Q 40 72 44 72 L 76 72 Q 80 72 80 74 L 80 116 Q 80 122 74 122 L 46 122 Q 40 122 40 116 Z" fill="var(--mouse-detail)" />
      <path d="M 60 72 L 60 122" stroke="var(--mouse-accent)" strokeWidth="1.5" opacity="0.5" />
      ...
      fontFamily: "'Inter Tight', sans-serif"
        ...
        <text x="52" y="13" textAnchor="middle" fontSize="8" fill="var(--mouse-body)" fontWeight="600">
          Olá, eu sou o Mouse!
        </text>
