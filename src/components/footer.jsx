...
function Footer() {
  return <Container className="p-0 px-4 m-0 w-full mx-auto min-h-0">
      <footer className={`border-t border-foreground pt-6 pb-6 grid grid-cols-12 gap-4 items-center w-full`}>
