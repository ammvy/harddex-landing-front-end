export function detailOrder(d) {
  return d === "basic" ? 1 : d === "mid" ? 2 : 3;
}
export function shouldShow(rowLevel, currentLevel) {
  return detailOrder(rowLevel) <= detailOrder(currentLevel);
}
export function winner(row) {
...
export function buildPhoneRows(a, b) {
  const sa = a.specs;
  const sb = b.specs;
  return [{
    section: "Desempenho",
    rows: [{
      ...
      a: {
        display: sa.process,
        raw: parseFloat(sa.process)
      },
      b: {
        display: sb.process,
        raw: parseFloat(sb.process)
      }
    }, {
      label: "GPU",
      ...
      better: "higher",
      a: {
        display: `${sa.gpuTflops}`,
        raw: sa.gpuTflops
      },
      b: {
        display: `${sb.gpuTflops}`,
        raw: sb.gpuTflops
      }
    }, {
      label: "Memória RAM",
      ...
      better: "higher",
      a: {
        display: `${sa.ram} GB ${sa.ramType}`,
        raw: sa.ram
      },
      b: {
        display: `${sb.ram} GB ${sb.ramType}`,
        raw: sb.ram
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.ramSpeed} MHz`,
        raw: sa.ramSpeed
      },
      b: {
        display: `${sb.ramSpeed} MHz`,
        raw: sb.ramSpeed
      }
    }, {
      label: "AnTuTu",
    ...
    rows: [{
      ...
      better: "none",
      a: {
        display: `${sa.display.size}"`,
        raw: sa.display.size
      },
      b: {
        display: `${sb.display.size}"`,
        raw: sb.display.size
      }
    }, {
      label: "Resolução",
      ...
      better: "none",
      a: {
        display: sa.display.res,
        raw: 0
      },
      b: {
        display: sb.display.res,
        raw: 0
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.display.refresh} Hz`,
        raw: sa.display.refresh
      },
      b: {
        display: `${sb.display.refresh} Hz`,
        raw: sb.display.refresh
      }
    }, {
      ...
      better: "none",
      a: {
        display: sa.display.panel,
        raw: 0
      },
      b: {
        display: sb.display.panel,
        raw: 0
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.display.nits} nits`,
        raw: sa.display.nits
      },
      b: {
        display: `${sb.display.nits} nits`,
        raw: sb.display.nits
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.display.gamut}%`,
        raw: sa.display.gamut
      },
      b: {
        display: `${sb.display.gamut}%`,
        raw: sb.display.gamut
      }
    }]
  }, {
    ...
    rows: [{
      ...
      better: "higher",
      a: {
        display: `~${sa.battery.life} h`,
        raw: sa.battery.life
      },
      b: {
        display: `~${sb.battery.life} h`,
        raw: sb.battery.life
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.battery.charge} W`,
        raw: sa.battery.charge
      },
      b: {
        display: `${sb.battery.charge} W`,
        raw: sb.battery.charge
      }
    }, {
    ...
    rows: [{
      ...
      better: "higher",
      a: {
        display: `${sa.camera.main} MP`,
        raw: sa.camera.main
      },
      b: {
        display: `${sb.camera.main} MP`,
        raw: sb.camera.main
      }
    }, {
      label: "Ultra-wide",
      ...
      better: "higher",
      a: {
        display: `${sa.camera.ultra} MP`,
        raw: sa.camera.ultra
      },
      b: {
        display: `${sb.camera.ultra} MP`,
        raw: sb.camera.ultra
      }
    }, {
      label: "Teleobjetiva",
      ...
      better: "higher",
      a: {
        display: `${sa.camera.videoK}K`,
        raw: sa.camera.videoK
      },
      b: {
        display: `${sb.camera.videoK}K`,
        raw: sb.camera.videoK
      }
    }]
  }, {
    ...
    rows: [{
      ...
      better: "higher",
      a: {
        display: `${sa.storage} GB`,
        raw: sa.storage
      },
      b: {
        display: `${sb.storage} GB`,
        raw: sb.storage
      }
    }, {
      label: "Tipo",
      ...
      better: "none",
      a: {
        display: sa.storageType,
        raw: 0
      },
      b: {
        display: sb.storageType,
        raw: 0
      }
    }, {
      ...
      better: "higher",
      a: {
        display: `${sa.read} / ${sa.write} MB/s`,
        raw: sa.read
      },
      b: {
        display: `${sb.read} / ${sb.write} MB/s`,
        raw: sb.read
      }
    }]
  }, {
...
export function buildLaptopRows(a, b) {
  const sa = a.specs;
  const sb = b.specs;
  return [{
    section: "Desempenho",
    ...
    rows: [{
      ...
      better: "lower",
      a: {
        display: `${sa.display.response} ms`,
        raw: sa.display.response
      },
      b: {
        display: `${sb.display.response} ms`,
        raw: sb.display.response
      }
    }]
  }, {
    section: "Bateria & Carregamento",
    rows: [{
      ...
      better: "higher",
      a: {
        display: `${sa.battery.capacity} Wh`,
        raw: sa.battery.capacity
      },
      b: {
        display: `${sb.battery.capacity} Wh`,
        raw: sb.battery.capacity
      }
    }, {
      label: "Duração estimada",
    ...
    rows: [{
      ...
      better: "none",
      a: {
        display: sa.ports.join(" · "),
        raw: sa.ports.length
      },
      b: {
        display: sb.ports.join(" · "),
        raw: sb.ports.length
      }
    }, {
      label: "Sistema",
    ...
    rows: [{
      ...
      better: "lower",
      a: {
        display: `${sa.weight} kg`,
        raw: sa.weight
      },
      b: {
        display: `${sb.weight} kg`,
        raw: sb.weight
      }
    }, {
      label: "Dimensões",
