...
export function MouseAvatar({
  ...
  return <div className="flex flex-col items-center gap-2 w-full md:w-fit shrink-0">
      <div className={`w-28 h-28 md:w-32 md:h-32 shrink-0 ${isAnimating ? "animate-wobble-mouse-fast" : "animate-wobble-mouse"}`}>
        {(() => {
