  ...
  return <div className="min-h-screen w-full bg-background text-foreground transition-colors duration-200" style={{
    fontFamily: "'Inter Tight', sans-serif"
      ...
      <main className="max-w-[1400px] mx-auto px-6 lg:px-12 py-10 lg:py-14">
        <ProfileHeaderTitle isEditing={isEditing} onStartEdit={startEdit} onCancelEdit={cancelEdit} onSubmit={onSubmit} />
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 lg:gap-8">
          ...
          {/* Fields column */}
          <ProfileFields user={user} isEditing={isEditing} register={form.register("name")} error={form.formState.errors.name?.message} onCancelEdit={cancelEdit} onSubmit={onSubmit} />
        </div>
      </main>
    </div>;
}