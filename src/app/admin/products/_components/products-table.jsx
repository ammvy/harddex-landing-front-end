...
export default function ProductsTable({
  ...
  return <div>
      <SectionHead kicker="Catálogo" title="Produtos" action={<button onClick={() => setEditing(emptyProduct())} style={{
      ...
      <div className="flex items-center gap-2 flex-wrap mb-4">
        <SearchBar value={q} onChange={setQ} placeholder="Buscar produto ou marca" />
      ...
      <div className="border border-border overflow-x-auto bg-background">
        <table className="w-full min-w-[640px] text-left">
          ...
          <tbody className="divide-y divide-border/40 text-foreground">
            ...
            return <tr key={p.id} className="hover:bg-input-background/40 transition-colors duration-75">
                  ...
                  fontFamily: "'Space Mono', monospace"
                      ...
                      {p.averagePrice ? `R$ ${p.averagePrice.toLocaleString("pt-BR")}` : "Sob consulta"}
                    </span>
                  </td>
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <IconBtn title="Excluir" danger onClick={() => setConfirmDel(p)}>
      ...
      <AnimatePresence>
        {editing && <ProductEditModal product={editing} brands={brands} categories={categories} onClose={() => setEditing(null)} onSave={saveProduct} />}

        {confirmDel && <Modal title="Excluir produto" onClose={() => setConfirmDel(null)} footer={<>
          ...
          fontFamily: "'Space Mono', monospace"
                ...
                <button onClick={() => deleteProduct(confirmDel.id)} style={{
          fontFamily: "'Space Mono', monospace"
