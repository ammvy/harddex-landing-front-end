...
export default function AdminDashboard() {
  ...
  return <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {stats.map((s, i) => <div key={s.label} className="p-6 bg-[var(--card)] border border-[var(--border)] rounded-lg shadow-sm hover:border-[var(--primary)] transition-colors duration-200">
