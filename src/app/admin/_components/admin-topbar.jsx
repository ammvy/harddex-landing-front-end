...
export default function AdminTopbar({
  ...
  return <div className="border-b border-border sticky top-0 z-30 bg-background h-[68px]">
      <div className="h-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <button onClick={onMenuToggle} className="lg:hidden w-9 h-9 border border-border flex items-center justify-center hover:text-primary hover:border-primary transition-colors duration-100 cursor-pointer text-foreground" aria-label="Menu">
          ...
          <Link href="/">
            <div className="relative inline-block select-none">
              ...
              <span aria-hidden className="absolute left-[-3%] right-[-3%] top-[43%] h-[12%] mix-blend-multiply bg-primary" />
            </div>
          </Link>
          <span style={{
        ...
        fontFamily: "'Space Mono', monospace"
          ...
          <ThemeToggle />
          <Link href="/" className="w-9 h-9 border border-border flex items-center justify-center hover:text-primary hover:border-primary transition-colors duration-100 cursor-pointer text-foreground" aria-label="Voltar">
