...
export function ResultPhase({
  ...
  return <motion.div key="result" initial={{
    opacity: 0,
    y: 24
  }} animate={{
    opacity: 1,
    ...
    duration: 0.45
      ...
      <div className="col-span-12 lg:col-span-5">
        <div className="border border-foreground bg-black text-white aspect-[4/5] flex flex-col transition-colors duration-200">
          <div className="px-6 pt-6 flex items-center justify-between font-mono-brand" style={{
          ...
          <div className="px-6 pb-6 border-t border-white/15 pt-5 font-mono-brand" style={{
          fontFamily: "'Space Mono', monospace"
        }}>
            <div className="uppercase tracking-widest text-[9px] text-white/50">
              Você é
            </div>
            <div className="uppercase text-[28px] leading-none mt-2 font-bold" style={{
      ...
      <div className="col-span-12 lg:col-span-7">
        ...
        <div className="mt-8">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {profile.specs.map(s => <div key={s} className="border border-foreground/20 px-4 py-3 flex items-center gap-3 transition-colors duration-200">
        ...
        <div className="mt-8">
          ...
          <ScoreDistribution ranking={ranking} winner={winner} winnerTotal={winnerTotal} />
        </div>
