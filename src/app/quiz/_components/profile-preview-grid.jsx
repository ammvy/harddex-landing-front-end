...
export function ProfilePreviewGrid() {
  return <div className="border border-foreground/20 bg-foreground/[0.02] p-8 transition-colors duration-200">
      ...
      <div className="mt-5 grid grid-cols-3 gap-3">
        {Object.keys(PROFILES).map(pid => <div key={pid} className="aspect-square bg-black text-white flex flex-col items-center justify-between p-3 relative group hover:ring-2 hover:ring-primary transition-all duration-150">
            <span style={{
          fontFamily: "'Space Mono', monospace"
      ...
      <div className="mt-6 pt-5 border-t border-foreground/15 grid gap-2 font-mono-brand" style={{
      fontFamily: "'Space Mono', monospace"
    }}>
